...
def main():
    ...
    if pilihmenu == "LATAR BELAKANG":
        ...
        if Menu == "Kubus":
            ...
            pilihan_rumus = st.selectbox("Pilih Rumus : ", ("Luas Permukaan", "Volume"))
            ...
            if pilihan_limas == "Limas Segitiga":  # Limas Segitiga
                ...
                if st.button("Hitung"):
                    if panjang_alas > 0 and tinggi_alas > 0 and tinggi_limas > 0:
                        if Rumus == "Volume":
                            st.write(f"Volume Limas Segiempat: {hitung_volume_limas_segiempat(panjang, lebar, tinggi)} cm³")
                    else:
